...
one technique used to pass information between different controllers is to use the flash message. Obviously, you do not do this in production, but it can be helpful when developing if you need to pass data quickly between controllers for some reason. Sessions should be used as a production-ready solution
